...
const HIDDEN_LEVELS = [
  ...
  },
  {
    ...
    title: '左路包抄',
    N: 5,
    path: [16,21,20,15,10,11,12,17,22,23,24,19,18,13,14,9,4,3,8,7,2,1,6,5,0],
    keyNumbers: [1,8,12,16,25],
    startIndex: 16,
    description: '起点在左下区域。1→8 close pair（曼哈顿1但需7步大幅绕行），16→25 长段9步。路径在左右区域之间折返。',
    difficultyLabel: '标准推理'
  },
  {
    id: 'hidden-demo-09',
  ...
  },
  {
    ...
    title: '左缘推理',
    N: 5,
    path: [10,15,20,21,16,11,12,17,22,23,24,19,18,13,14,9,4,3,8,7,2,1,6,5,0],
    keyNumbers: [1,6,12,19,25],
    startIndex: 10,
    description: '起点在左边缘中部。1→6 close pair（曼哈顿2但需5步），12→19 绕行4步。段长均匀分布（5/6/7/6），适合作为 easy 段收官关。',
    difficultyLabel: '标准推理'
  }
];
