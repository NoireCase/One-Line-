// Production Edge Puzzle Foundation · Board geometry（纯函数）
...
// 命中参数唯一来源（P4B 实测候选值，未冻结；hitTesting 不再重复定义）：
 ...
 *   corridorHalfWidth, tieEpsilon,  // 命中参数（viewBox 域，由 HIT_PARAMS 注入）
 * }
 */
