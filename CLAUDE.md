...
Playwright E2E tests live in `e2e/`. They cover home, mode selection, settings, mouse/keyboard input, save/restore, win/lose panels, Hidden, GM candidate review, and Portal 2.0 (Portal Collect).
...
| File                 | Responsibility                                                                                                             |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `gameModes.js`       | Play mode definitions (classic/diagonal/hidden/portalClassic/portalCollect), level structure, localStorage key helpers        |
